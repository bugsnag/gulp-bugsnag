...
[new issue](https://github.com/bugsnag/gulp-bugsnag/issues/new). There are a couple
of things you should check before doing so:

- Do you have the latest version of gulp-bugsnag? If not, does updating to the latest
version fix your issue?
- Has somebody else [already reported](https://github.com/bugsnag/gulp-bugsnag/issues?utf8=%E2%9C%93&q=is%3Aissue%20is%3Aopen) your issue? Feel free to comment or check-in on an existing issue that matches your own.
...
- [Fork](https://help.github.com/articles/fork-a-repo) the [repo on github](https://github.com/bugsnag/gulp-bugsnag)
...
of work, the best thing to do is [create an issue](https://github.com/bugsnag/gulp-bugsnag/issues/new)
